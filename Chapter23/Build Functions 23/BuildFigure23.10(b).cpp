...
World::build(void) {
	...
	body_ptr->read_smooth_triangles("penguin_body.ply");
	...
	left_wing_ptr->read_smooth_triangles("penguin_left_wing.ply");
	left_wing_ptr->set_material(matte_ptr2);  
	left_wing_ptr->setup_cells();
	
	Grid* right_wing_ptr = new Grid;
	right_wing_ptr->read_smooth_triangles("penguin_right_wing.ply");
	...
	left_foot_ptr->read_smooth_triangles("penguin_left_foot.ply");
	left_foot_ptr->set_material(matte_ptr3);  
	left_foot_ptr->setup_cells();
	
	Grid* right_foot_ptr = new Grid;
	right_foot_ptr->read_smooth_triangles("penguin_right_foot.ply");
	...
	left_eyeball_ptr->read_smooth_triangles("penguin_left_eyeball.ply");
	left_eyeball_ptr->set_material(matte_ptr4);  
	left_eyeball_ptr->setup_cells();
	
	Grid* right_eyeball_ptr = new Grid;
	right_eyeball_ptr->read_smooth_triangles("penguin_right_eyeball.ply");
