...
// This builds the scene for Figure 29.26 where the vertical curved surface of the 
// jar body is red. This surface is completely covered by the texture image
// in Figure 29.26.
// The aspect ratio of the image is designed for this particular jar.
...
World::build(void) {
	...
	product_jar_ptr->set_body_material(body_matte_ptr);		// renders the vertical body surface red
