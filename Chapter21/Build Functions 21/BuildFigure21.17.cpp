...
// This builds the scene for Figure 21.17.

// This build function is the same as the build function for Figure 21.11(a).
// The different image results from changes to the rosette code. See Rosette.cpp.
